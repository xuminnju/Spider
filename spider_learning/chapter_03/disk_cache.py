...
class DiskCache:
    """
       ...
       Traceback (most recent call last):
        ...
       KeyError: 'http://example.webscraping.com/places/default/index has expired'
       >>> cache.clear()
       """
    ...
    def url_to_path(self, url):
        ...
        # 去掉文件名中的places/default/
        filename = re.sub(r'places/default/', '', filename)
...
if __name__ == '__main__':
    link_crawler('http://example.webscraping.com/places/default/index', '/places/default/view|/places/default/index', cache=DiskCache())